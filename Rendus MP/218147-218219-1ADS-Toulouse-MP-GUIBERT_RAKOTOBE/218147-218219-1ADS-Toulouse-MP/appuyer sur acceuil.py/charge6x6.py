...
def recommencer():
    ...
    ligne=3
    global nbrdedpion
    nbrdepion=marshal.load(open("snbrdepion", "rb"))
    global rotation
    global plateau1
    global plateau2
    global plateau3
...
ligne=3
rotation=[]
plateau1=marshal.load(open("splateau1", "rb"))
plateau2=marshal.load(open("splateau2", "rb"))
plateau3= marshal.load(open("splateau3", "rb"))
plateau4= marshal.load(open("splateau4", "rb"))
...
def sauvegarde():
    ...
    marshal.dump(cptnoir, open("scptnoir", 'wb'))
    marshal.dump(cptnoir, open("scptblanc", 'wb'))
    marshal.dump(plateau1, open("splateau1", 'wb'))
    marshal.dump(plateau2, open("splateau2", 'wb'))
    marshal.dump(plateau3, open("splateau3", 'wb'))
    marshal.dump(plateau4, open("splateau4", 'wb'))
    marshal.dump(nbrdepion, open("snbrdepion", 'wb'))
    marshal.dump(joueur, open("sjoueur", 'wb'))
...
player=2
nbrdepion=marshal.load(open("snbrdepion", "rb"))
joueur = marshal.load(open("sjoueur", "rb"))
cptnoir=marshal.load(open("scptnoir", "rb"))
cptblanc= marshal.load(open("scptblanc", "rb"))
fin=False
execo=False
a=1
affichepion()
