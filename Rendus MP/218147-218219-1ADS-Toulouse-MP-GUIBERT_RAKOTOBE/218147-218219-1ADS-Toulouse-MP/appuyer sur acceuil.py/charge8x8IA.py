...
def recommencer():
    ...
    ligne=4
    global nbrdedpion
    nbrdepion=marshal.load(open("IA1snbrdepion", "rb"))
    global rotation
    global plateau1
    global plateau2
    global plateau3
...
ligne=4
rotation=[]
plateau1=marshal.load(open("IA1splateau1", "rb"))
plateau2=marshal.load(open("IA1splateau2", "rb"))
plateau3= marshal.load(open("IA1splateau3", "rb"))
plateau4= marshal.load(open("IA1splateau4", "rb"))
...
def sauvegarde():
    ...
    marshal.dump(cptnoir, open("IA1scptnoir", 'wb'))
    marshal.dump(cptnoir, open("IA1scptblanc", 'wb'))
    marshal.dump(plateau1, open("IA1splateau1", 'wb'))
    marshal.dump(plateau2, open("IA1splateau2", 'wb'))
    marshal.dump(plateau3, open("IA1splateau3", 'wb'))
    marshal.dump(plateau4, open("IA1splateau4", 'wb'))
    marshal.dump(nbrdepion, open("IA1snbrdepion", 'wb'))
    marshal.dump(joueur, open("IA1sjoueur", 'wb'))
basta=1        
gagner=True              
inProgress =True
graphplateau()
...
player=2
nbrdepion=marshal.load(open("IA1snbrdepion", "rb"))
joueur = marshal.load(open("IA1sjoueur", "rb"))
cptnoir=marshal.load(open("IA1scptnoir", "rb"))
cptblanc= marshal.load(open("IA1scptblanc", "rb"))
fin=False
execo=False
a=1
c=1
