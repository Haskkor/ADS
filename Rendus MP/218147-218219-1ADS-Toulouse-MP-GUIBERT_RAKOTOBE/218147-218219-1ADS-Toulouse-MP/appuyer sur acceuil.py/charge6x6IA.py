...
def recommencer():
    ...
    ligne=3
    global nbrdedpion
    nbrdepion=marshal.load(open("IAsnbrdepion", "rb"))
    global rotation
    global plateau1
    global plateau2
    global plateau3
...
ligne=3
rotation=[]
plateau1=marshal.load(open("IAsplateau1", "rb"))
plateau2=marshal.load(open("IAsplateau2", "rb"))
plateau3= marshal.load(open("IAsplateau3", "rb"))
plateau4= marshal.load(open("IAsplateau4", "rb"))
...
player=2
nbrdepion=marshal.load(open("IAsnbrdepion", "rb"))
joueur = marshal.load(open("IAsjoueur", "rb"))
cptnoir=marshal.load(open("IAscptnoir", "rb"))
cptblanc= marshal.load(open("IAscptblanc", "rb"))
fin=False
execo=False
a=1
c=1
